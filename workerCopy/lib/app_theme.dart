...
/// from highway signs and license plates, which suits a truck wash app. If the font
...
// ---------------------------------------------------------------------------
//
// Night shift  = dark theme  (evening / early-morning shifts, low glare)
// Daylight     = light theme (bright sun on a phone screen at the wash bay)
//
...
// ---------------------------------------------------------------------------
//
// Sizes are deliberately a step larger than typical apps: workers read this
// at arm's length, outdoors, often with wet or gloved hands. Labels are sentence case.
